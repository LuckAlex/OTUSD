...
output_dir = './result/stylegan2_ffhq'
num = 1
...
for i in tqdm(range(num)):
    ...
    codes = torch.randn(1, generator.z_space_dim).to(device)
    ...
    u = np.load('boundary/stylegan_ffhq/smile/stylegan_ffhq_smile_31_15.npy')
